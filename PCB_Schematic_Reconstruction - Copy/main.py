...
def main(image_path):
    # --- CẤU HÌNH ---
    model_path = r"G:\xu_li_anh\PCB_Schematic_Reconstruction - Copy - Copy - Copy-20251219T140956Z-3-001\PCB_Schematic_Reconstruction - Copy - Copy - Copy\models\pcb_high_res3\weights\best.pt"
...
if __name__ == "__main__":
    ...
    test_image =r"G:\xu_li_anh\pcb_xanh.jpg"
